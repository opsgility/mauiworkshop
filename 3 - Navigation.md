...
1. Open `MauiProgram.cs` and add both the view model and the page as `Transient` below the other .AddSingleton() calls so a new page and view model is created each time it is navigated to:
...
1. The final XAML should look like this:
